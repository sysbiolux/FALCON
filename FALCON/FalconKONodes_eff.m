...
for counter =  1:size(p_KD,2)
    ...
    [MeanStateValueAll, StdStateValueAll, MeanCostAll, StdCostAll, estim] = FalconSimul(estim,bestx,[0 0 0 0 0]);
    MeanStateValueAll = MeanStateValueAll(:, find(ismember(estim.state_names, estim_orig.state_names)))
    StateValue_screen = [StateValue_screen ; MeanStateValueAll];
