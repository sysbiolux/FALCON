...
MaxFunEvals = 30000; % Number of maximal function being evaluated (3000 = default)
MaxIter = 30000; % Number of maximal iteration being evaluated (3000 = default)
...
for Try = 1:6
    ...
    switch Try
        case 1
            estim.Weights = [1 1 1 1 0 1];
        case 2
            estim.Weights = [1 1 1 1 0.001 1];
        case 3
            estim.Weights = [1 1 1 1 0.005 1];
        case 4
            estim.Weights = [1 1 1 1 0.025 1];
        case 5
            estim.Weights = [1 1 1 1 0.125 1];
        case 6
            estim.Weights = [1 1 1 1 1 1];
    end
    ...
    MSEs = [MSEs, [fxt_all(1,1);MeanCostAll]]
end

figure, 
subplot(1,2,1), 
bar(MSEs(1,:)), title('Obj'), set(gca, 'xticklabel', {'0','0.001','0.005','0.025','0.125','1'}), 
subplot(1,2,2), 
bar(MSEs(2,:)), title('MSE'), set(gca, 'xticklabel', {'0','0.001','0.005','0.025','0.125','1'})
