...
% fix Lambda values
PowerLambda12=-10:0.5:2;; % L1/2
PowerLambda1group=-10:0.5:2;; % L1group
% 
% PowerLambda12=-10:2:1;; % L1/2
% PowerLambda1group=-10:2:1;; % L1group
...
InputFile=[ExampleFolder filesep 'crosstalk_model_final.xlsx']; %% Network structure file
ExpName='Greta';
% ContextsList={'parental_4h','parental_16h','parental_48h','izi_cond_4h','izi_cond_16h','izi_cond_48h'};
ContextsList={'parental','izi_cond'};

MeasFileList={};
for f=1:length(ContextsList)
    
    MeasFileList=[MeasFileList,[ExampleFolder filesep 'crosstalk_' char(ContextsList(f)) '_16h.xlsx']];
end
Max=10;
GlobalEdgesList=[ExampleFolder filesep 'crosstalk_model_fixed.xlsx'];
